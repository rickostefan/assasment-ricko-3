 ...
 * 
 * @author     Agentpoint
 * @copyright  (c) Copyright by Agentpoint
 * @subpackage Core
 * @version    1.0.0
 * @since      1.0.0
 */
...
use includes\NetPointTheme;
use includes\NetPointThemeOptions;

class NetPointThemeOptionsCustom {
	/**
	 * The class instance.
	 *
	 * @since 1.0.0
	...
	*/
	...
	/**
	 * Construct the custom admin object.
	 *
	 * @since 1.0.0
	 * 
	 * @access public
	...
	{
		add_filter( 'netpoint_custom_options', array( $this, 'netpoint_custom_options_new' ) );
		add_filter( 'assesment_3_timezones', array( $this, 'timezone_custom' ) );
	}

	/**
		 * Creates the custom theme options
		 *
		 * @since 1.0.0
		 *
		 * @access public
		 * @static
		 *
		 * @return array all of custom options
		 */
	public function netpoint_custom_options_new($options_new)
	{
		$options_new = array(
			array(
				"name" => "New Field Custom",
				"type" => "open"
			),
			array(
				"name" => "Silahkan pilih timezone Title",
				"id" => "pilih_section_title",
				"type" => "text"
			),
			array(
				"type" => "close"
	...
	/**
	 * Enqueues custom style and scripts.
	 *
	 * @since 1.0.0
	 *
	 * @access public
	 ...
	 *
	 */
	public function timezone_custom() 
	{
